...
marketingCategory.addEventListener('click', function(e) {
    ...
    if (Array.isArray(detailData)) {
        const filteredData = detailData.filter(category => category.categoryRelation === "Marketing"); // Modify this condition to match your data structure
...
designCategory.addEventListener('click', function() {
    ...
    const filteredData = detailData.filter(category => category.categoryRelation === "Design");
    // Rest of the code...
...
brandingCategory.addEventListener('click', function() {
    ...
    const filteredData = detailData.filter(category => category.categoryRelation === "Branding");
    // Rest of the code...
