  ...
  allCategory.addEventListener('click', function() {
    ...
    if (Array.isArray(detailData)) {
        detailData.forEach(category => {
            ...
            <div class="row col-html">
            <div class="col-lg-4 col-md-6 dropzone" style="font-size: 1.75rem; text-align: center;"
...
// "portfolioTitle": "Runway Rogue",
// "portfolioDescription": "Contoured some impressive paid advertising results through retargeting campaigns and stunning content.",
// "categoryRelation": "Web Design",
// "portfolioImage": "https://elfinder.owlapplicationbuilder.com/files/1580295343903/simpler_digital_marketing_1580295343903_96/2.png",
// "title": "Runway Rogue_935",
// "slug": "runway-rogue-522_4",