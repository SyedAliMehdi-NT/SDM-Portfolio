    ...
    .then(data => {
        ...
        function renderCategory(categoryToFilter, data) {
            ...
            if (Array.isArray(data.data)) {
                if (categoryToFilter === "All") { /* Check if the category is "All" */
                    itemsToRender = data.data;     /* If "All", render everything */
                } else {
                    itemsToRender = data.data.filter(category => category.categoryRelation === categoryToFilter);
                }
        ...
        function toSearch(element) {
            switch (element.id) {
                case 'Marketing-category':
                    return 'Marketing';
                case 'webdesign-category':
                    return 'Web Design';
                case 'branding-category':
                    return 'Branding';
                default:
                    return null;
            }
