...
.then(data => {
  ...
  marketingCategory.addEventListener('click', function() {
    console.log("Marketing is clicked!")
...
// // A function to filter and render cards based on the category
// function filterAndRenderCards(categoryToSearch) {
...
//   if (Array.isArray(detailData)) {
//     detailData.forEach(category => {
//       if(category.categoryRelation === categoryToSearch) { // Only render when the category matches
//         const titleData = category.title;
//         const descriptionData = category.portfolioDescription;
//         const titleImage = category.portfolioImage;
//         const detailBtn = category.slug;
//         const cardWise = `    <div class="col-lg-4 col-md-6 col-html" style="font-size: 1.75rem; text-align: center;"
//         data-comp-title="Grid Column">
...
//   filterAndRenderCards('Marketing'); // Assuming 'Marketing' is the name you use in categoryRelation for Marketing items
// });

// designCategory.addEventListener('click', function(e) {
//   e.preventDefault();
//   console.log("Design category is clicked!")
//   filterAndRenderCards('Design'); // Assuming 'Design' is the name you use in categoryRelation for Design items
// });
...
//   filterAndRenderCards('Branding'); // Assuming 'Branding' is the name you use in categoryRelation for Branding items
// });
